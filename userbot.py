...
with app:
    app.update_profile(first_name="GolgiBody")
    app.update_profile(bio="( @GolgiBody Alt ) Ads wali bakchodi krne k chakkar me id logout...")
    print("Profile name aur bio update ho gaya hai!")
